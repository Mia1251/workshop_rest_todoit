package se.lexicon.todo_it_api.conversions;
...
public Person toPerson(PersonFormDto personFormDto){

    return new Person(0, personFormDto.getFirstName(),personFormDto.getLastName(),personFormDto.getBirthDate(),new ArrayList<>());

}
public TodoItem toTodoItem(TodoItemFormDto todoItemFormDto){

    return new TodoItem(0,todoItemFormDto.getTitle(),todoItemFormDto.getDescription(),todoItemFormDto.getDeadLine(),todoItemFormDto.isDone(),null);
}
...
public PersonDto toPersonDto(Person person) {
    ...
    public TodoItemDto toTodoDto (TodoItem todoItem){
        ...
        TodoItemDto todoDto = new TodoItemDto(todoItem.getTodoId(), todoItem.getTitle(), todoItem.getDescription(), todoItem.getDeadLine(), todoItem.isDone(), personDtoSmall);
